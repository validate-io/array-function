...
function create( fcn ) {
	...
	// Check whether input argument is an array
	f += 'if( Object.prototype.toString.call( a ) !== \'[object Array]\' ) {';
	f += 'throw new TypeError( \'invalid input argument. Argument must be an array. Value: `\' + a + \'`.\' );';
	f += '}';
